        ...
        <ScreenContainer>
            <ScrollView style={{padding:10}}>
                    ...
                    <View style={styles.container}>
                        ...
                        <Text style={styles.paragraph}>
                            L’application est accessible aux personnes disposant de la pleine capacité juridique pour s’engager au titre des présentes « conditions générales d’utilisation »
                        </Text>
                        <Text style={styles.paragraph}>
                            La personne physique qui ne dispose pas de la pleine capacité juridique ne peut accéder à l’application et aux services qu’avec l’accord de son représentant légal.
                        </Text>
                        <Text style={styles.paragraph}>
...
serveur n’engage pas la responsabilité de l’entreprise
                        </Text>
                        <Text style={styles.paragraph}>
                            L’accès aux services de l’application peut à tout moment faire l’objet d’une interruption, d’une suspension, d’une
modification moyennant un préavis de 24 heures sauf urgence pour une maintenance ou pour tout autre cas
d’origine technique, l'utilisateur s’obligeant à ne réclamer aucune indemnisation.
                        </Text>
                        <Text style={styles.paragraph}>
                            Dans un souci d’amélioration, l’entreprise se réserve le droit à tout moment de modifier les caractéristiques ou le
contenu de l’application, est peut également restreindre l'accès à certaines rubriques et ce, sans avertissement
préalable.
                        </Text>
                        <Text style={styles.paragraph}>
                            L’utilisateur a la possibilité de contacter l’entreprise par messagerie électronique à l’adresse:
appmystere@gmail.com
                        </Text>
...
L'utilisation de la fonctionnalité notification de l'application nécessite le consentement préalable de l'utilisateur. Pour cela, l'utilisateur doit autoriser l'application "Mystère" à lui envoyer des notifications. Cette fonctionnalité peut à tout moment être désactivée ou activée dans le Menu de l’application.
 En autorisant les "notifications", l'utilisateur peut recevoir des messages (sous forme de texte) à caractère informatif, même si l'application est fermée.</Text>
                        ...
                        <Text style={styles.paragraph}> L’entreprise est propriétaire exclusive des droits intellectuels afférents à cette application article L112-2 du code de
la propriété intellectuelle. </Text>
                        <Text style={styles.paragraph}> En conséquence, la reproduction, la copie, la diffusion, l'enregistrement, la cession, la représentation et l'altération
d'un des éléments quelconques de l'application sont strictement interdits, sauf autorisation express et préalable de
l’entreprise. </Text>
                        <Text style={styles.paragraph}> L'utilisation à des fins commerciales est strictement interdite et pourra faire l’objet de poursuites judiciaires.
Toute infraction à ces dispositions exposerait son auteur à des sanctions civiles et pénales. </Text>


                        <Text style={styles.heading}>Article 5 - Limitations de responsabilité:</Text>

                        <Text style={styles.paragraph}> L’entreprise décline toute responsabilité quant à l’utilisation qui pourrait être faite des informations et contenus
                        présents sur l’application Mystère, vous êtes seul responsable des dommages et préjudices, directs ou indirects,
                        matériels ou immatériels dès lors qu'ils auraient pour cause, fondement ou origine un usage de l’application par
                        vous-même ou par toute personne autorisée par vous à utiliser l’application. Par usage, il convient d'entendre tout
                        usage de l’application quel qu'il soit.</Text>
                        <Text style={styles.paragraph}> L’entreprise ne saurait être tenue responsable des risques ou conséquences des risques pouvant résulter de la
                        situation ou de l’état des lieux recommandés tels que garde-fou, chutes de pierre etc... Il appartient à l’utilisateur
                        de se renseigner sur les risques et dangers auxquels pourrait l’exposer la situation ou l’état des lieux visités.</Text>

                        <Text style={styles.heading}>Article 6 - Liens et sites tiers:</Text>

                        <Text style={styles.paragraph}> L’entreprise ne peut garantir la véracité des informations qu’elle ne maîtrise pas telles qu’issues de liens
hypertextes exploités provenant de tiers.</Text>
 <Text style={styles.paragraph}>  L’entreprise ne pourra en aucun cas être tenue pour responsable de la disponibilité technique de sites internet ou
d’applications mobiles exploités par des tiers auxquels l’utilisateur accéderait par l’intermédiaire de l’application.</Text>
...
leurs sont propres.</Text>
                        ...
                        <Text style={styles.paragraph}>L’utilisation de la présente application est prévue pour une durée indéterminée sans que pour autant l’entreprise
puisse en garantir une pérennité absolue.{'\n'}
L’utilisateur peut désinstaller l'application à tout moment.</Text> 

                        <Text style={styles.heading}>Article 8 - Loi applicable et attribution de juridiction:</Text>
                        ...
                        <Text style={styles.paragraph}>Pour être activée, l’application demandera à l’utilisateur de lui donner la possibilité de le géolocaliser. Elle ne
fonctionnera que sous cette condition.</Text> 
                        <Text style={styles.paragraph}>L’application tient également compte de l'article L34-1-V du code des postes et des communications électroniques.</Text>
                        <Text style={styles.paragraph}>L’utilisateur peut à tout moment et sans aucuns frais désactiver la fonction localisation via son terminal.</Text>
                        <Text style={styles.paragraph}>L’entreprise ne conserve aucune information liée à la localisation des utilisateurs.</Text>
                        <Text style={styles.paragraph}>L’utilisateur accepte d’utiliser des services tiers de géolocalisation externes à l’application. L’entreprise décline
                        toute responsabilité quant à la fiabilité des tiers externes choisis.</Text>
                        <Text style={styles.paragraph}>L’utilisateur choisi par ses propres moyens un système de géolocalisation fourni par des tiers et régis par leurs
propres conditions d’utilisation.</Text>


                        <Text style={styles.heading}>Article 10 - Photographies et descriptions:</Text>
